...
@MapperScan(sqlSessionFactoryRef = "db5SqlSessionFactory")
public class DB5Config {
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier("db5DataSource") DataSource dataSource) throws Exception {
	...
	public SqlSessionTemplate sqlSessionTemplate(
			@Qualifier("db5SqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
