...
INSERT INTO iframe (category, url, name, height, sort) VALUES
     ('log', 'http://loki-grafana.choshsh.com/d/XeS0yvN7z/kube-all-resource-log?orgId=1', 'ALL', '1100', 1),
     ('log', 'http://loki-grafana.choshsh.com/d/JqglEFN7z/kube-control-plane-log?orgId=1', 'Control Plane', '1000', 2),
     ('metric', 'http://loki-grafana.choshsh.com/d/dn42GQH7z/linux?orgId=1', 'Node', '2200', 1),
