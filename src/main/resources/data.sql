...
VALUES
     ...
     ('metric', 'http://grafana.choshsh.com/d/LJ_uJAvmk/istio-service-dashboard?orgId=1', 'Istio', '2300', 'Istio 네트워크 모니터링', 2),
     ('metric', 'http://grafana.choshsh.com/d/ku9BHmOnz/jvm-micrometer?orgId=1', 'JVM', '3300', 'Prometheus Kubernetes SD를 위한 Annotation이 있는 JVM 앱 모니터링', 3),
...
INSERT INTO user (user_id, user_name, user_pw, role)
VALUES
...
VALUES
     ...
     ('PROMETHEUS_URL', 'http://loki-prometheus-server.monitoring.svc');
